...
export const LoginForm = () => {
  ...
  return (
    <Container className="animeLeft">
      ...
      <h1 className='title titleForm'>Logistic Inc.</h1>
      <Input 
        label={userIcon}
        type='text'
        name='username'
      ...
      <div className='auxContainer'>
        <Link to='recoverPassword' className='forgotPassword'>Esqueceu sua senha?</Link>
        <hr />
        <Link to='register' className='registerNow'>Cadastre-se</Link>
      </div>
    </Form>
